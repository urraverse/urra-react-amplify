...
export default function FormSubmissionCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setFinancialPriority(initialValues.financialPriority);
    setErrors({});
  };
  const validations = {
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new FormSubmission(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "FormSubmissionCreateForm")}
      {...rest}
    >
      <TextField
        label="First name"
